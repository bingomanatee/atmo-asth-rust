...
pub fn energy_at_layer(layer_index: usize, layer_height: f64, volume_km3: f64) -> f64 {

    let depth_km = (layer_index as f64 + 0.5) * layer_height;
    let temp_k = ASTHENOSPHERE_SURFACE_START_TEMP_K + GEOTHERMAL_GRADIENT_K_PER_KM * depth_km;
