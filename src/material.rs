...
pub static MATERIAL_PROFILES: Lazy<HashMap<MaterialType, MaterialProfile>> = Lazy::new(|| {
    ...
    m.insert(Silicate, MaterialProfile {
        ...
        thermal_transmission_r0_min: 800.0,  // 800 km reference radius (deep mantle)
        thermal_transmission_r0_max: 1200.0, // 1200 km reference radius (deep mantle)
    ...
    m.insert(Basaltic, MaterialProfile {
        ...
        thermal_transmission_r0_min: 600.0,  // 600 km reference radius (upper mantle)
        thermal_transmission_r0_max: 1000.0, // 1000 km reference radius (upper mantle)
    ...
    m.insert(Granitic, MaterialProfile {
        ...
        thermal_transmission_r0_min: 400.0,  // 400 km reference radius (shallow mantle)
        thermal_transmission_r0_max: 800.0,  // 800 km reference radius (shallow mantle)
    ...
    m.insert(Metallic, MaterialProfile {
        ...
        thermal_transmission_r0_min: 2000.0, // 2000 km reference radius (core materials)
        thermal_transmission_r0_max: 3000.0, // 3000 km reference radius (core materials)
