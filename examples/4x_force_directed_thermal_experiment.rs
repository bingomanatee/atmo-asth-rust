...
impl OneKm2Simulation {
    ...
    fn print_final_analysis(&self) {
        ...
        let material_type = first_node.energy_mass.material_composite_type();
        let composite = get_material_core(&material_type);
...
fn main() {
    ...
    let mut experiment = OneKm2Simulation::new(steps, total_years);
