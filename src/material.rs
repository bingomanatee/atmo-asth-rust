...
pub static MATERIAL_PROFILES: Lazy<HashMap<MaterialType, MaterialProfile>> = Lazy::new(|| {
    ...
    m.insert(Silicate, MaterialProfile {
        ...
        thermal_transmission_r0_min: 0.00000001, // 0.000001% minimum thermal transmission (ultra-realistic geological)
        thermal_transmission_r0_max: 0.00000002, // 0.000002% maximum thermal transmission (ultra-realistic geological)
    ...
    m.insert(Basaltic, MaterialProfile {
        ...
        thermal_transmission_r0_min: 0.000000008, // 0.0000008% minimum thermal transmission (ultra-realistic geological)
        thermal_transmission_r0_max: 0.000000016, // 0.0000016% maximum thermal transmission (ultra-realistic geological)
    ...
    m.insert(Granitic, MaterialProfile {
        ...
        thermal_transmission_r0_min: 0.000000006, // 0.0000006% minimum thermal transmission (ultra-realistic geological)
        thermal_transmission_r0_max: 0.000000014, // 0.0000014% maximum thermal transmission (ultra-realistic geological)
    ...
    m.insert(Metallic, MaterialProfile {
        ...
        thermal_transmission_r0_min: 0.00000002, // 0.000002% minimum thermal transmission (ultra-realistic geological)
        thermal_transmission_r0_max: 0.00000003, // 0.000003% maximum thermal transmission (ultra-realistic geological)
    ...
    m.insert(Icy, MaterialProfile {
        ...
        thermal_transmission_r0_min: 0.000000005, // 0.0000005% minimum thermal transmission (ultra-realistic geological)
        thermal_transmission_r0_max: 0.000000012, // 0.0000012% maximum thermal transmission (ultra-realistic geological)
