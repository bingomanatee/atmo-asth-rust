...
impl ColorLookupTable {
    ...
    pub fn new(min_log_energy: f64, max_log_energy: f64, table_size: usize) -> Self {
   ...
   pub fn get_color(&self, energy_density_j_per_km3: f64) -> Rgb<u8> {
...
pub struct ThermalHeatMapExportOp {
...
impl ThermalHeatMapExportOp {
    pub fn new(resolution: Resolution, points_per_degree: u32, export_every_step: bool,  directory: &str) -> Self {
    ...
    fn export_heat_map_png(
        ...
        let filename = format!("examples/{}/heat_map_step_{:04}.png", self.directory, step);
    ...
    fn cleanup_old_images(&self) {
        ...
        let output_dir = format!( "examples/{}/", &self.directory);
